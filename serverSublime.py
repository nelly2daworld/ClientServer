...
# Store all key/value pairs in here.
    database = librarySublime.KeyValueStore()
    ...
    # client.
      ...
      # Read a command.
      command_line = librarySublime.ReadCommand(client_sock)
      command, name, text = librarySublime.ParseCommand(command_line)
      ...
      if command == 'PUT':
        ...
        result = SendText(client_sock, 'Unknown command %s' % command)
